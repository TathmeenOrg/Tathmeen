                                   ...
                                   if ($result->num_rows > 0) {
                                       while ($user = $result->fetch_assoc()) {
                                           ...
                                           echo '<td>
                                                   ...
                                                   <a href="editAccount.php?id=' . $user['id'] . '" class="btn btn-outline-warning ms-1">
                                       ...
                                       echo "<tr><td colspan='6' style='text-align: center; color: #d63384'>لا يوجد مستخدمين حاليًّا في النظام.</td></tr>";
                                   }
                                   ?>
